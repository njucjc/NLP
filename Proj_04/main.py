...
from data_utils import load_word2vec, create_input, input_from_line, BatchManager, decode
...
flags.DEFINE_float("batch_size",    512,         "batch size")
...
flags.DEFINE_string("predict_file", os.path.join("data", "original", "test.content.txt"),   "Path for test data")
